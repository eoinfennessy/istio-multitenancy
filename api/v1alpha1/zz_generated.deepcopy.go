...
func (in *AdditionalEgress) DeepCopyInto(out *AdditionalEgress) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdditionalEgress.
func (in *AdditionalEgress) DeepCopy() *AdditionalEgress {
	if in == nil {
		return nil
	}
	out := new(AdditionalEgress)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ZoneSpec) DeepCopyInto(out *ZoneSpec) {
	*out = *in
	...
	if in.AdditionalEgress != nil {
		...
		*out = make([]AdditionalEgress, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
